...
const themeScript = `(function(){try{var overridden=localStorage.getItem('noadflow-theme-overridden')==='1';var t;if(overridden){t=localStorage.getItem('noadflow-theme');if(t!=='light'&&t!=='dark'){t=window.matchMedia('(prefers-color-scheme: light)').matches?'light':'dark';}}else{t=window.matchMedia('(prefers-color-scheme: light)').matches?'light':'dark';}document.documentElement.setAttribute('data-theme',t);}catch(e){document.documentElement.setAttribute('data-theme','dark');}})();`;
